...
class Oficios:
    def __init__(self, window):
        ...
        self.wind = window
        self.wind.title('OCUPACIONES Y OFICIOS')
    ...
    def widget_frame_treeview(self, parametros):
        ...
        self.treeview = Treeview(frame_left, columns=[f"#{n}" for n in range(0, 2)], height=8) #columns=[f"#{n}" for n in range(0, 2)],
        ...
        self.treeview.column('#1', stretch=False, width=100, minwidth=64)    #220
